...
echo "#          For Kali Linux                  #"
echo "############################################"
echo " Modified by: Greg Hendrickson https://github.com/aisthanestha/dvwa_installer"
echo " Updated By: Josh Stroschein http://www.m9development.com/damn-vulnerable-web-application-dvwa-installation-script-for-kali-linux/"
echo " Original Script by Travis Phillips: http://theunl33t.blogspot.com/2011/08/script-to-download-configure-and-launch.html"
...
echo -n "[*] Copying DVWA to /var/www/html..."
...
sed -e 's/p@ssw0rd//' /var/www/html/config/config.inc.php1 > /var/www/html/config/config.inc.php
